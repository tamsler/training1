...
function getUsersV1(req, res, next) {
    ...
    mongo.find("users", {}, { 'fields' : {'loginId' : 1, 'firstName' : 1, 'lastName' : 1 } }, function(err, users) {
...
function deleteUserV1(req, res, next) {
    ...
    if("loginId" === idType) {
        ...
        queryDoc["_id"] = mongo.objectID(id);
    }
    else {
...
function postUserLoginV1(req, res, next) {
    ...
    mongo.findOne(
        ...
        { 'fields' : {'loginId' : 1, 'firstName' : 1, 'lastName' : 1, 'authToken' : 1, 'userRole' : 1}},
        function(err, user) {
